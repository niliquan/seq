...
class PersonalPageHandler(BaseHandler):
    ...
    def get(self,name):
        ...
        userinfo=User(**userinfo)
        questions=yield motor.Op(self.db.posts.find,{"author":{"email":userinfo.email}})
        self.render("personalpage.html", userinfo=userinfo , questions=questions )
